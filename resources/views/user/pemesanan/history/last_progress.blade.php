        ...
        <div class="row row-layanan">
            <ul class="nav nav-tabs">
                <li class="nav-item col-md-6">
                  <a class="nav-link text-center text-dark fs-5"  href="/user/pemesanan/history/on_progress">Pesanan</a>
                </li>
                <li class="nav-item col-md-6">
                  <a class="nav-link text-center active text-success fw-bold fs-5" aria-current="page" href="/user/pemesanan/history/last_progress">History</a>
                </li>
            </ul>
            <div class="mt-3">
                    ...
                    <div class="mt-2" style="max-width: 100%;">
                        <div class="row g-0">
                            <div class="col-md-3 p-4">
                                <img src="{{ asset('assets/img/motor2.jpeg') }}" class="img-fluid rounded-start" alt="..." style="width: 100%; margin-left: 10px">
                            </div>
                            <div class=" col-md-9">
                                <div class="card-body">
                                    <div class="row">
