            ...
            <div class="container mt-2 mb-2">
                <div class="row row-layanan">
                    <div class="col-lg-5 mt-5">
                        <figure class="figure">
                            <img src="{{ asset('assets/img/kos.jpeg') }}" class="figure-img img-fluid" style="border-radius: 5px; width: 450px">
                            <figcaption class="figure-caption d-flex justify-content-evenly">
                                <a href="#">
                                    <img src="{{ asset('assets/img/kos.jpeg') }}" class="figure-img img-fluid" style="border-radius: 5px; width: 80px">
                                </a>
                                <a href="#">
                                    <img src="{{ asset('assets/img/kos.jpeg') }}" class="figure-img img-fluid" style="border-radius: 5px; width: 80px">
                                </a>
