                ...
                <div class="row justify-content-center">
                    <div class="card" style="background-color: #fff; width:85% ">
                        <div class="card-body mt-3">
                            ...
                            <p class="text-muted">Daftarkan tempat parkir anda dengan mengisi data dibawah ini</p></p><br>
                            <h6>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <a href="/vendor/vendor/Kelola-Kendaraan/atur_alamat"><button class="btn btn-success mb-3">Tambah</button></a>
                                </div>
                                <hr>
                            </div>
