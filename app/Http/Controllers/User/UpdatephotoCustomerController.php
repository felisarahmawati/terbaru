...
class UpdatephotoCustomerController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if(request()->hasFile('photo')) {
            ...
            $request->photo->move(storage_path('app/public/photoscustomer'), $fileName);
            //foto yang sudah diupload akan masuk ke folder storage/public/photoscustomer
            $user->photo = $fileName;
        }
